            ...
            <div class="w-full max-w-md">
                ...
                <form id="currency-converter-form" class="space-y-6">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="relative">
                            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                <span id="currency-symbol" class="text-gray-500">$</span>
                            </div>
                            <input type="text" name="price" id="price"
                                class="block w-full rounded-lg border border-gray-300 py-2 pl-12 pr-20 text-gray-900 placeholder-gray-400 focus:border-indigo-500 focus:ring focus:ring-indigo-200 sm:text-sm"
                                placeholder="0.00">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="relative">
                            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                <span id="currency-symbol-2" class="text-gray-500">Rp</span>
                            </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function updateCurrencySymbol() {
            ...
            currencySymbol.innerHTML = `${symbol} `; // Adds space after the symbol
        }

        function updateToCurrencySymbol() {
            const selectedToCurrency = toCurrency.value;
            const symbol = currencySymbols[selectedToCurrency] || '$';
            currencySymbol2.innerHTML = `${symbol} `; // Adds space after the symbol
        }
        ...
        // Initialize currency options and symbol on page load
        updateCurrencySymbol();
        updateToCurrencySymbol();
        updateCurrencyOptions();
    });
